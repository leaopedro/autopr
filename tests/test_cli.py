...
from autopr.cli import main as autopr_main, handle_commit_command, handle_pr_create_command
...
class TestMainCLI(unittest.TestCase):
    ...
    @patch('autopr.cli.get_repo_from_git_config') 
    def test_workon_command_calls_start_work_on_issue_updated(self, mock_get_repo, mock_start_work_on_issue):
        issue_number = 789
        mock_get_repo.return_value = "owner/repo"
